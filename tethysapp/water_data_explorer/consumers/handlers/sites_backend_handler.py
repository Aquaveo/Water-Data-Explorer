...
from tethysapp.water_data_explorer.model.schemas import  CUAHSISiteCreate, CUAHSISiteRead,CUAHSIVariableRead
...
class SitesBackendHandler(RBH):
    ...
    SEND_GET_SITES: BackendActions = BackendActions.GET_SITES
    ...
    @RBH.action_handler
    async def handle_get_sites(self, event, action, data, session):
        """
        ...
        try:
            ...
            await self.send_action(self.SEND_GET_SITES, sites_json)
