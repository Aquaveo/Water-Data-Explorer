...
const handlers = [
  rest.get('http://api.test/api/apps/water_data_explorer/', (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.json({
        ...
        "urlNamespace": "water_data_explorer",
        "color": "",
        "icon": "/static/water_data_explorer/images/icon.png",
        "exitUrl": "/apps/",
        "rootUrl": "/apps/water_data_explorer/",
